...
{
  {
    servercred.on("/", []() {
      ...
      String ipStr = String(ip[0]) + '.' + String(ip[1]) + '.' + String(ip[2]) + '.' + String(ip[3]);
       ...
       content += "<p>";
       content = "<!DOCTYPE HTML>\r\t\n<html>Welcome to Wifi Credentials Update page, Please restart the device if the required Wifi is not visbile below";
       content += "<p>";
     // content = "<!DOCTYPE HTML>\r\n\n<html>Please restart the device if the required Wifi is not visbile below";
     // content += "<p>";
